...
// Dati di accesso validi (esempio hardcoded, sostituire con database in produzione)
$correct_username = "lise";
$correct_password = "123456";

$error_message = ""; // Variabile per gestire errori
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username === $correct_username && $password === $correct_password) {
        // Se le credenziali sono corrette, reindirizza alla pagina di destinazione
        header("Location: https://sites.google.com/casimiri.edu.it/lisemeitner/introduzione");
        exit; // Fermiamo l'esecuzione del resto del codice dopo il reindirizzamento
    } else {
        // Se le credenziali sono errate, mostra un messaggio di errore
        $error_message = "Credenziali errate!"; // Messaggio di errore
    }
}
?>
...
<head>
    ...
    <style media="screen">
        ...
        * { padding: 0; margin: 0; box-sizing: border-box; }
        ...
        .social div { width: 150px; border-radius: 3px; padding: 5px 10px 10px 5px; background-color: rgba(255,255,255,0.27); color: #eaf0fb; text-align: center; }
